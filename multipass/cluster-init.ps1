...
Write-Host "Deleting unecessary folders from transfer staging area."
...
Write-Host "Copying cluster list and SSH keys for transfer to the cluster VMs."
...
Write-Host "Initializing kubeadm on k8s-controller."
